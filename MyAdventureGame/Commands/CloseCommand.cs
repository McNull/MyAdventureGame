...
{
    /// <summary>
    /// Console command to close items.
    /// </summary>
    public class CloseCommand : Command
    {
        ...
        {
            return "Closes the specified item.";
        }
        ...
        public override void Execute(string[] args)
        {
            ...
            if (item != null)
            {
                ...
                {
                    this.Output.Write("That cannot be closed.\n");
                }
                else
                {
                    openableItem.Close(this.Player);
                }
            }
        }
